$(document).ready(function () {
    ...
    $("#RateButton").click(function () {
        ...
        window.location.assign("HouseDetail.html");
        ...
        $.each(properties,function(index,value){
            ...
            if(act.name==value.name && act.owner==value.owner){
                $.each(users,function(index,val){
                    if(val.username==act.owner){
                        let p = val.properties;
                        for(let i=0; i<p.length;i++){
                            if(p[i].name == act.name){
                                p[i].capacity="Full";
                            }
                        }
                    }
    ...
    $("#Validate").click(function () {
        ...
        let atividades = JSON.parse(localStorage.getItem("properties"));
        ...
        localStorage.setItem("properties", JSON.stringify(atividades));
    ...
    $("#SaveEdit").click(function () {
        ...
        if (valid) {
            ...
            let name = properties["current"].name;
